...
\begin{figure}[htbp]\label{fig:fff}
    \subfigure[]{\label{fig:specnormal}\includegraphics[width=0.45\textwidth]{resources/specnormal.png}}
    \subfigure[]{\label{fig:speclog}\includegraphics[width=0.45\textwidth]{resources/speclog.png}}
    \caption{(a) Normal y-scale; (b) Log y-scale;}
\end{figure}

\subsection*{Use FFT to carry out spectral analysis and wave filteringc}
\inputminted[
frame=lines,
framesep=2mm,
baselinestretch=1.2,
...
linenos
]{python}{resources/FFT-analysis.py}
\end{document} 
